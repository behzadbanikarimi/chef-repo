...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "behzad20020-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/rubys"
  #   chef.validation_client_name = "rubys-validator"
  #   chef.validation_key_path = ".chef/rubys-validator.pem"
  # end
end
